...
class UserAccsesForm extends React.Component{
    ...
    render(){
      return (
          ...
          </>:<ActionBox text="Закрыть для всех" icon={<Link45deg />} action={()=>{this.setState({...this.state, checkeveryone:!this.state.checkeveryone}); axios.put(this.props.siteaddres+'set_conspect_private/'+this.props.conspectid)}}/>
      )
    }
}
